...
var isAuthenticatedUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var header, token;
    return __generator(this, function (_a) {
        try {
            ...
            jsonwebtoken_1.default.verify(token, 'Abhi18', function (err, user) {
                if (err) {
